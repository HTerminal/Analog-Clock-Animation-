...
cv2.rectangle(image, (190,170), (430,265), colors['dark_gray'], -1)
cv2.putText(image, date, (215,200), 1, 2, colors['light_gray'], 1, cv2.LINE_AA)
cv2.putText(image, day, (246,250), 1, 2, colors['light_gray'], 1, cv2.LINE_AA)
